...
import { useDisputes, useUserActions } from '@/hooks/p2p/useDispute'
...
export const DisputeTable: React.FC<UserTableProps> = ({
  filters,
  pagination,
  sort,
  onUserClick,
  ...
  const { data, isLoading, error } = useDisputes(filters, pagination, sort)
